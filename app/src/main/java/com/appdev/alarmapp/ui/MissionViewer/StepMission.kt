...
fun StepMission(
    ...
    DisposableEffect(Unit) {
        ...
        val onStepListener = object : StepDetector.StepListener {
            override fun stepDetect(count: Int) {
                Log.d("CHKST", "$count in main")
                stepsToBeDone -= 1
            }
        }
        stepDetector.setOnStepListener(onStepListener)
