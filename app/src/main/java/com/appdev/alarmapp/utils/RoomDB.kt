...
@Database(
    entities = [RingtoneEntity::class, AlarmEntity::class, SystemRingtone::class, CustomPhrase::class,ImageData::class,QrCodeData::class,DefaultSettings::class,AlarmSetting::class,DismissSettings::class],
    version = 18,
    exportSchema = false
)
